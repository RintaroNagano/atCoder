...
func solve() {
	...
	if n <= 1000-1 {
		fastio.Println(n)
	} else if 1000 <= n && n <= 10000-1 {
		fastio.Println(n - n%10)
	} else if 10000 <= n && n <= 100000-1 {
		fastio.Println(n - n%100)
	} else if 100000 <= n && n <= 1000000-1 {
		fastio.Println(n - n%1000)
	} else if 1000000 <= n && n <= 10000000-1 {
		fastio.Println(n - n%10000)
	} else if 10000000 <= n && n <= 100000000-1 {
		fastio.Println(n - n%100000)
	} else if 100000000 <= n && n <= 1000000000-1 {
		fastio.Println(n - n%1000000)
	}
}
